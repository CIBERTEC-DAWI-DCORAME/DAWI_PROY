...
public class Cliente {
	...
	public Cliente(Integer idCliente, String nombre, String apePat, String apeMat, String fecNac, String direccion,
	...
	public Cliente(String nombre, String apePat, String apeMat, String fecNac, String direccion,
			String urbanizacion, Integer idDepartamento, Integer idProvincia, Integer idDistrito, String email,
			String password, String celular) {
		this.nombre = nombre;
		this.apePat = apePat;
	...
	public String toString() {
		return "Cliente [idCliente=" + idCliente + ", nombre=" + nombre + ", apePat=" + apePat + ", apeMat=" + apeMat
