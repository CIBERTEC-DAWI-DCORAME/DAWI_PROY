...
DROP DATABASE IF EXISTS db_decorame;
--
-- Base de datos: `lp2_db_decorame`
--
create database db_decorame;
...
--
ALTER TABLE `empresas`
  MODIFY `idEmp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
--
...
ALTER TABLE `empleados`
  ...
  ADD CONSTRAINT `PK_empleado_empresa` FOREIGN KEY (`idEmp`) REFERENCES `empresas` (`idEmp`);
--
...
--
ALTER TABLE `asesoramientos`
  ADD CONSTRAINT `PK_idAsesoramiento_empresa` FOREIGN KEY (`idEmp`) REFERENCES `empresas` (`idEmp`);
--
...
ALTER TABLE `pedidos`
  ...
  ADD CONSTRAINT `PK_pedido_empresa` FOREIGN KEY (`idEmp`) REFERENCES `empresas` (`idEmp`);
--
...
INSERT INTO `empresas` (`idEmp`, `rucEmp`, `nombreEmp`, `direccionEmp`, `teléfonoEmp`, `emailEmp`) VALUES
(1, '20100130204','D´Corame S.A', 'Los Zorzales 340 - Lince', 012701000, 'dCorame@gmail.edu.pe'),
(2, '20100130205','D´Corame S.A', 'Los Zorzales 340 - Lince', 012701000, 'dCorame@gmail.edu.pe');
...
INSERT INTO `empleados` (`idEmpleado`,`idEmp`, `nombre`, `apePat`, `apeMat`, `fecNac`, `direccion`, `urbanizacion`, `idDepartamento`, `idProvincia`, `idDistrito`, `email`, `password`, `celular`, `idPuesto`) VALUES
(1, 1,'Tatiana', 'Huaman', 'Orlando', '1993-07-12', 'Los jardines 23', 'Casa Blanca', 15, 50, 16, 'tati@gmail.com', '12345', '444888333', 1),
(2, 1,'Cecilia', 'NuÃ±ez', 'Cerna', '1987-07-03', 'Av Arequipa 34', 'Los Mangos', 15, 50, 17, 'cecilianunes@gmail.com', '12345', '888777444', 3),
(3, 1,'Franceso', 'Rossi', 'Berlusconi', '1950-05-27', 'Calle italia 34', 'Rabiones', 4, 73, 2, 'francesorossi@gmail.com', '12345', '333777555', 2),
(4, 1,'Laura', 'Ferrari', 'Brambilla', '2005-07-21', 'Calle las Magnolia 34', 'Los Jazminez azules', 5, 24, 6, 'laura@gmail.com', '12345', '333888555', 2),
(5, 1,'Umberto', 'Garcia', 'Abanto', '1979-12-11', 'Los Sauces', 'Miraflores', 20, 68, 36, 'umberto@gmail.com', '12345', '999555999', 4);
